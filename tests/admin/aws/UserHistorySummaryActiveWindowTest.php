                    ...
                    Change history		  	</div>
                      <ul class="list-group list-group-flush">
                        ...
                        <span>
                            ...
                            just now			    </span>
                                        <span class="badge badge-primary badge-pill" ng-click="hiddenElement1=!hiddenElement1">Diff</span>
                                        </li>
                        <li class="list-group-item p-0" ng-show="hiddenElement1">
                            <div class="table-responsive">
                            <table class="table table-sm table-striped table-borderless table-hoverable small">
                                <thead>
                                    <tr>
                                        <th class="w-25">Attribute</th>
                                        <th class="w-25">Old</th>
                        ...
                        <span>
                            ...
                            <span class="badge badge-info">ID #</span>
                            just now			    </span>
                                        <span class="badge badge-primary badge-pill" ng-click="hiddenElement2=!hiddenElement2">Diff</span>
                                        </li>
                        <li class="list-group-item p-0" ng-show="hiddenElement2">
                            <div class="table-responsive">
                            <table class="table table-sm table-striped table-borderless table-hoverable small">
                                <thead>
                                    <tr>
                        ...
                        <span>
                            ...
                            <span class="badge badge-info">ID #</span>
                            just now			    </span>
                                        <span class="badge badge-primary badge-pill" ng-click="hiddenElement3=!hiddenElement3">Diff</span>
                                        </li>
                        <li class="list-group-item p-0" ng-show="hiddenElement3">
                            <div class="table-responsive">
                            <table class="table table-sm table-striped table-borderless table-hoverable small">
                                <thead>
                                    <tr>
