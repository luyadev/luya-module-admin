...
// 1.0.4
	...
	'aw_apioverview_resettokenconfirm' => 'Are you sure to replace the current token with a new one? This can not be undone!',
	...
	'aw_apioverview_accesstokeninfo' => 'If you set a new access token, ensure the old token is not used! Otherwise your application wont work anymore.',
