...
// 2.0
    ...
    'model_tag_translation_hint' => 'Uma tradução opcional para a tag no idioma especificado. Isso permite atribuir e gerar a mesma tag em sites multilíngues.',
    'active_button_timestamp_label' => 'Registro de data e hora',
    'active_button_timestamp_success' => 'Registro de data e hora foi definido com sucesso.',
    'active_button_timestamp_error' => 'Erro ao salvar o registro de data e hora.',
    'js_scheduler_show_datepicker' => 'Agenda',
    'js_scheduler_new_value' => 'Novo valor',
    'js_scheduler_time' => 'Tempo de execução',
    'js_scheduler_save' => 'Adicionar',
    'js_scheduler_title_upcoming' => 'Próximos',
    ...
    'js_dir_manager_rename_success' => 'O diretório foi renomeado com sucesso.',
    'layout_filemanager_search_no_results' => 'Nenhum arquivo encontrado para <strong>{{searchQuery}}</strong>.',
    'layout_filemanager_empty_folder' => 'Este diretório está vazio.',
    'aw_requestinsight_warning' => 'Esse recurso é usado principalmente para obter informações sobre uma determinada API. Não é recomendável habilitá-lo por um longo período de tempo, pois ele pode coletar muitos dados e tornar seu aplicativo mais lento.',
    'aw_requestinsight_logger_active' => 'A solicitação de informação está ativa!',
    'aw_requestinsight_btn_disable' => 'Desabilitar',
    'aw_requestinsight_btn_enable' => 'Habilitar',
    'aw_requestinsight_btn_clear' => 'Limpar Dados',
    'aw_requestinsight_btn_fetch' => 'Carregar Dados',
    'aw_requestinsight_request_label' => 'Requisições',
    'aw_requestinsight_col_date' => 'Data',
    'aw_requestinsight_col_type' => 'Tipo',
    'aw_requestinsight_col_url' => 'URL', // no translated
    'aw_requestinsight_col_time' => 'Tempo',
    'aw_requestinsight_col_count' => 'Contador',
    'aw_requestinsight_top_request_label' => 'URLs mais requeridas',
    'aw_requestinsight_longest_response_label' => 'URLs com Tempo de Resposta mais Longo',
    'aw_requestinsight_data_pagination' => '{{data.length}} de {{dataCount}} requisições',
    'aw_requestinsight_toggle_logger_enabled' => 'Solicitar informações está ativa.',
    'aw_requestinsight_toggle_logger_disabled' => 'Solicitar informações está desabilitada.',
    'aw_requestinsight_toggle_error' => 'Erro ao habilitar solicitar informações.',
    'aw_requestinsight_cleared' => 'Os dados foram apagados.',
    'aw_requestinsight_default_label' => 'Solicitar Informações',
    'login_noscript_error' => 'Para usar o LUYA o Javascript deve ser ativado.',
    'login_browsehappy' => 'Você está usando um navegador <strong>desatualizado</strong>. Por favor <a href="https://browsehappy.com/" target="_blank">atualize seu navegador</a> para uma melhor experiência e segurança.',
    'crud_notification_enable' => 'Habilitar Notificação',
    'crud_notification_disable' => 'Desativar Notificação',
    'admin_button_execute' => '"{label}" executado',
    'layout_btn_reload_admin' => 'Atualizar&nbsp;Admin',
...
// 2.0.3
    ...
    'status_true' => 'Sim',
    'status_false' => 'Não',
    'js_jsonobject_newkey' => 'Novo nome chave',

// 2.2.0

    'active_button_togglestatus_label' => 'Alternar status',
    'active_button_togglestatus_error' => 'Não pode ser ativado',
    'active_button_togglestatus_enabled' => '{modelName} ativado',
    'active_button_togglestatus_disabled' => '{modelName} desativado',
