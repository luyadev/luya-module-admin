...
// 1.2.0
    ...
    'account_changeemail_subject' => 'Email verification code',
    'account_changeemail_body' => '<h1>Security code</h1><p>Enter the following verification code to change your email address for the website {url}.</p><span style="font-size:22px; letter-spacing:2px; padding:5px 10px; display:inline-block; background-color:#F0F0F0;">{token}</span>',
