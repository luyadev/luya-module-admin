...
// 2.0
    ...
    'aw_requestinsight_warning' => ' This feature is mainly used to get insights for a given API. Its not recommend to enable this function over a long time as it can collect a lot of data which can slow down your application.',
    'aw_requestinsight_logger_active' => 'The request logger is currently active!',
    'aw_requestinsight_btn_disable' => 'Disable Logger',
    'aw_requestinsight_btn_enable' => 'Enable Logger',
    ...
    'aw_requestinsight_top_request_label' => 'Top requested Url',
    'aw_requestinsight_longest_response_label' => 'Longest response time',
    'aw_requestinsight_data_pagination' => '{{data.length}} of {{dataCount}} Requests',
    'aw_requestinsight_toggle_logger_enabled' => 'Logger is enabled.',
    'aw_requestinsight_toggle_logger_disabled' => 'Logger is disabled.',
    'aw_requestinsight_toggle_error' => 'Error while enabling request logger.',
