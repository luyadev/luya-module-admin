...
// added translations in version 4.2.0:
    'model_ngrestlog_user_id' => 'Пользователь',
    'model_ngrestlog_timestamp_create' => 'Время',
    'model_ngrestlog_route' => 'Маршрут',
    'model_ngrestlog_api' => 'API',
    'model_ngrestlog_is_update' => 'Обновление?',
    'model_ngrestlog_is_insert' => 'Вставка?',
    'model_ngrestlog_attributes_json' => 'Attributes Json', // TODO: Context needed
    'model_ngrestlog_attributes_diff_json' => 'Attributes Diff Json',
    'model_ngrestlog_pk_value' => 'Значение первичного ключа',
    'model_ngrestlog_table_name' => 'Имя таблицы',
    'model_ngrestlog_is_delete' => 'Удаление?',
    'model_property_module_name' => 'Имя модуля',
    'model_property_var_name' => 'Имя переменной',
    'model_property_class_name' => 'Имя класса',
    'model_property_sort_index' => 'Sort Index',
    'model_proxy_build_machine_id' => 'Machine ID',
    'model_proxy_build_timestamp' => 'Время',
    ...
    'model_proxy_machine_name' => 'Название',
    'model_proxy_machine_access_token' => 'Токен',
    'model_proxy_machine_is_deleted' => 'Удален?',
    'model_proxy_machine_is_disabled' => 'Неактивен?',
    'model_proxy_machine_identifier' => 'Идентификатор',
    ...
    'model_storageimage_file_id' => 'Файл',
    'model_storageimage_filter_id' => 'Фильтр',
    'model_storageimage_resolution_width' => 'Ширина',
    'model_storageimage_resolution_height' => 'Высота',
];
