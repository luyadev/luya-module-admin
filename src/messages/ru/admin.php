...
return [
    ...
    'layout_deleted_file' => 'Вы не можете применить фильтр, потому что исходный файл был удален. Загрузите или выберите новый файл, чтобы применить фильтр.',
    ...
    'layout_debug_remotetoken' => 'Возможность удаленного доступа к отладочной информации (remote token)',
